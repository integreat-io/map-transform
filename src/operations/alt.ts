...
import { State, Data, Operation, StateMapper, MapDefinition, Options } from '../types'
...
const getValueOrDefault = (state: State, runAlt: StateMapper) => (value: Data, index?: number) =>
